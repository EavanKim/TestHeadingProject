...
//	info->wsaBuf_.buf = info->storage_.halloc<CHAR>(MAXIMUM_PACKET_DATA_LENGTH); // 세션 관련 데이터는 한 데 몰아놨다가 한 방에 날리려고 하니까 사이즈 고민 해 보기. (예상 서버 스팩 램에서 데이터 할당량 / 필요 최저한도 동시접속자수)
